function [imdb, fnamestrain, fnamestest] = convertMat2imdb(modelfname, angles, perc_test,k)
...
[ Xtrain, Ytrain, Xtest, Ytest, indtrain, indtest ] = devide( X,k,y);% class labels 1-6   	
