#In the test part of GCN, the obtained features are saved in the feature folder.
...
for fold in range(1,11):
    ...
    #        sio.savemat(att_path, {'att': a_att})
        ...
        Accuracy=(a[0,0]+a[1,1]+a[2,2]+a[3,3])/a.sum()
        F1_ave=sum(F1_score[0])/4
        print(Accuracy)
        print(F1_ave)
        name='./confusion_matrix/'+str(fold)+'.mat'
        sio.savemat(name, {'confusion_matrix': a})
