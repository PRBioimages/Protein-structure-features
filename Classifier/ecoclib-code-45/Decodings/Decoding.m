...
function [X,result,confusion,labels,Values]=Decoding(TestData,classes,ECOC,base,Classifiers,decoding,base_test,base_test_params,custom_decoding,custom_decoding_param)
